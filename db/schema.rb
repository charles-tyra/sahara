...
ActiveRecord::Schema[7.0].define(version: 2023_05_01_010756) do
  ...
  create_table "carts", force: :cascade do |t|
    ...
    t.index ["item_id", "owner_id"], name: "index_carts_on_item_id_and_owner_id", unique: true
  ...
  create_table "reviews", force: :cascade do |t|
    ...
    t.index ["item_id", "author_id"], name: "index_reviews_on_item_id_and_author_id", unique: true
